 ...
 * </pre>
 */
public final class BusUtilsExt {
     ...
     * by function of {@link BusUtilsExt#registerBus} when execute transform task.
     */
    ...
    private static BusUtilsExt getInstance() {
    ...
    private static class LazyHolder {
        private static final BusUtilsExt INSTANCE = new BusUtilsExt();
    }
}