package com.blankj_custom.base_transform
...
import com.blankj_custom.base_transform.util.ZipUtils
...
abstract class BaseTransformPlugin<T> implements Plugin<Project>, BaseTransformCallback<T> {
    ...
    void apply(Project project) {
        if (project.plugins.hasPlugin(AppPlugin)) {
            ...
            def clazz = getGenericClass()
            log('project(' + project.toString() + ') apply ' + getPluginName() + ' gradle plugin! clazz = ' + clazz)
            project.extensions.create(getPluginName(), clazz)
